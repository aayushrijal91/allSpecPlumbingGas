            ...
            <div class="row justify-content-around align-items-center gx-xl-6 pt-4 pt-md-7 position-relative gy-5 gy-lg-0">
                ...
                <div class="col-lg-6 px-xl-5">
                    ...
                    <div class="custom_tab my-5">
                        <div class="tab-navigation rounded-pill mb-5">
                            <button type="button" for="integrity_safety" class="navi-link active">
                                <svg width="19" height="19" viewBox="0 0 19 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.2182 3.16171C14.7189 3.16171 11.7834 2.28634 9.74088 0.930325C9.47488 0.753043 9.12892 0.753043 8.86292 0.930325C6.81963 2.28634 3.88413 3.16171 1.38484 3.16171C0.947837 3.16171 0.59317 3.51391 0.59317 3.94963C0.59317 10.5477 3.73213 15.826 8.98959 18.0684C9.08934 18.1109 9.19542 18.1322 9.3015 18.1322C9.40759 18.1322 9.51367 18.1109 9.61342 18.0684C14.8709 15.826 18.0098 10.5477 18.0098 3.94963C18.0098 3.51391 17.6552 3.16171 17.2182 3.16171ZM9.3015 16.4815V9.46507H3.07979C2.56521 8.0153 2.26121 6.41819 2.19234 4.71155C4.61009 4.55791 7.27642 3.73847 9.3015 2.51956V9.46507H15.5232C14.3911 12.6522 12.2378 15.1271 9.3015 16.4815Z" />
                                </svg>

                                Safety
                            </button>
                            <button type="button" for="integrity_eco_friendliness" class="navi-link">
                        ...
                        <div class="tab-content">
                            <div class="custom_tab_content active" id="integrity_safety">
